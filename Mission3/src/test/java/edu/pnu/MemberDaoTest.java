...
//		memberDao = new MemberDaoMysql();
	...
	public void getMembersTest() {
		...
		ArrayList<MemberVO> list = memberDao.getMembers();
		for(MemberVO m : list) {
	...
	public void getMemberTest() {
		...
		int id = 10;
		MemberVO m = memberDao.getMember(id);
		System.out.println(m);
	}
	...
	public void updateMemberTest() {
		...
		MemberVO mm = memberDao.updateMember(id, m);
	...
	public void deleteMemberTest() {
		...
		int id = 13;
		MemberVO m = memberDao.deleteMember(id);
		if (m != null)
			System.out.println(m);
		else
